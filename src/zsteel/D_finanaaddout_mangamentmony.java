 ...
 * @author mahmoud
 */
public class D_finanaaddout_mangamentmony extends javax.swing.JDialog {

    /**
     * Creates new form D_finanaaddout_closemoney
     */
    public D_finanaaddout_mangamentmony(D_finanaddout parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public D_finanaaddout_mangamentmony ()
    {
        super();
     initComponents();   
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("مصروفات اداريه");
        ...
        jLabel2.setText("المبلغ المسحوب");
...
new D_finanaaddout_closemony_addmangament(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_mangamentmony.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_mangamentmony dialog = new D_finanaaddout_mangamentmony(new D_finanaddout(), true);
