 ...
 * @author mahmoud
 */
public class D_finanaaddout_custorecall extends javax.swing.JDialog {

    /**
     * Creates new form D_finanaaddout_closemoney
     */
    public D_finanaaddout_custorecall(D_finanaddout parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public D_finanaaddout_custorecall ()
    {
        super();
     initComponents();   
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("مرتجع نقدى لعميل");
        ...
        jLabel2.setText("المبلغ المرتجع");
...
new D_finanaaddout_custorecall_getcus(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_custorecall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_custorecall dialog = new D_finanaaddout_custorecall(new D_finanaddout(), true);
