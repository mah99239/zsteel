...
public class f_custmor extends javax.swing.JFrame {
       DefaultTableModel m ;
 ...
 table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
       */
        ...
        jComboBox2.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    }
    ...
    private void initComponents() {
        ...
        jBarchife = new javax.swing.JButton();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "عرض كل الحسابات", "حسابات خالصه", "حسابات غير خالصه" }));
        ...
        jLabel10.setText("بيانات العملاء والتجار");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "كل المتعاملين ", "تجار فقط", "عملاء فقط" }));
        ...
        jLabel1.setText("عرض بالماليات");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("عرض بالنوع");

        jLabel3.setText("موبايل وعنوان");
        ...
        table.setModel(new DefaultTableModel(new Object[0][], new String []{"مسلسل","نوع المتعامل","الاسم","العنوان","موبايل","دائن","مدين","اخر دفعه","تاريخ اخر تحديث"}));
        ...
        jBadd.setText("اضافه متعامل جديد");
        ...
        jBacountstatment.setText("كشف الحساب");
        ...
        jBarchife.setBackground(new java.awt.Color(250, 250, 250));
        jBarchife.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/archive_32px.png"))); // NOI18N
        jBarchife.setText("ارشيف المعاملات الماليه");
        jBarchife.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jBarchife.setContentAreaFilled(false);
        jBarchife.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jBarchife.setOpaque(true);
        jBarchife.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        jBarchife.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jBarchife.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jBarchifeMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jBarchifeMouseExited(evt);
            }
        });
        ...
        jBedit.setText("تعديل بيانات المتعامل");
        ...
        jBdelete.setText("مسح بيانات المتعامل");
        ...
        jpgroubLayout.setHorizontalGroup(
            ...
            .addGroup(jpgroubLayout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addComponent(jBedit, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
                .addComponent(jBarchife, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
        ...
        jpgroubLayout.setVerticalGroup(
            ...
            .addGroup(jpgroubLayout.createSequentialGroup()
                ...
                .addGroup(jpgroubLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jBarchife, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jBacountstatment, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//setContentPane(blurLayer);
    ...
    private void jBarchifeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBarchifeMouseEntered
       jBarchife.setBackground(Color.LIGHT_GRAY);
    }//GEN-LAST:event_jBarchifeMouseEntered

    private void jBarchifeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBarchifeMouseExited
jBarchife.setBackground(Color.white);
        // TODO add your handling code here:
    }//GEN-LAST:event_jBarchifeMouseExited
 ...
 table.setRowHeight(table.getRowHeight()+1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(f_custmor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public  void dtable ()
    {
        String [] columnx = {"مسلسل","نوع المتعامل","الاسم","العنوان","موبايل","دائن","مدين","اخر دفعه","تاريخ اخر تحديث"};
       ...
       table.setModel(m);
        ...
        
        {
            ...
            m = new DefaultTableModel(columnz,0){
         public boolean iscelleditable(int row , int column)
         {
             return true;
         }
        ...
        table.setModel(m);
        Object []a={"1","سيليبليبل","sdf","sfd","fsd","fds","fsd","sdf","sdf"};
        
        
        m.addRow(a);
        m.addRow(a);m.addRow(a);
        m.addRow(a);m.addRow(a);
        m.addRow(a);m.addRow(a);
        m.addRow(a);m.addRow(a);
        m.addRow(a);m.addRow(a);
  ...
  */
    ...
    private javax.swing.JButton jBarchife;
