 ...
 * @author mahmoud
 */
public class D_cusarchivemony extends javax.swing.JDialog {

    DefaultTableModel m;
    public D_cusarchivemony(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ارشيف المعاملات الماليه لعميل");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 0, 190, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_cusarchivemony.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_cusarchivemony dialog = new D_cusarchivemony(new javax.swing.JFrame(), true);
