 ...
 * @author mahmoud
 */
public class D_finanaaddout_erceipt_getsupplier extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finanaaddout_erceipt_getsupplier(D_finanaaddout_receipt  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_erceipt_getsupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_erceipt_getsupplier dialog = new D_finanaaddout_erceipt_getsupplier(new D_finanaaddout_receipt(), true);
