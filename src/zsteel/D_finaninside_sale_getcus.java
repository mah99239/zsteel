 ...
 * @author mahmoud
 */
public class D_finaninside_sale_getcus extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finaninside_sale_getcus(D_finaninside_sale  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_sale_getcus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_sale_getcus dialog = new D_finaninside_sale_getcus(new D_finaninside_sale(), true);
