 ...
 * @author mahmoud
 */
public class D_finanaaddout_erceipt_getcustomer extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finanaaddout_erceipt_getcustomer(D_finanaaddout_receiptcust  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_erceipt_getcustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_erceipt_getcustomer dialog = new D_finanaaddout_erceipt_getcustomer(new D_finanaaddout_receiptcust(), true);
