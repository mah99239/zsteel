 ...
 * @author mahmoud
 */
public class D_finaninside_suppdiscount_getsupp extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finaninside_suppdiscount_getsupp(D_finaninside_suppdiscount  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 480, 210, 20));
    ...
    private void jbaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbaddActionPerformed
        // TODO add your handling code here:
        new D_supaddsupllier(new JFrame(), true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_suppdiscount_getsupp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_suppdiscount_getsupp dialog = new D_finaninside_suppdiscount_getsupp(new D_finaninside_suppdiscount(), true);
