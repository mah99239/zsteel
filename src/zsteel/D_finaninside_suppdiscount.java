 ...
 * @author mahmoud
 */
public class D_finaninside_suppdiscount extends javax.swing.JDialog {

    /**
     * Creates new form D_finanaaddout_closemoney
     */
    public D_finaninside_suppdiscount(D_finaninside parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public D_finaninside_suppdiscount ()
    {
        super();
     initComponents();   
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("خصم على حساب مورد");
...
new D_finanaddout_data(this, true).setVisible(true);
    ...
    private void jlgetsupplMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlgetsupplMouseClicked
        new D_finaninside_suppdiscount_getsupp(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_suppdiscount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_suppdiscount dialog = new D_finaninside_suppdiscount(new D_finaninside(), true);
