 ...
 * @author mahmoud
 */
public class D_finanaaddout_closemoney extends javax.swing.JDialog {

    /**
     * Creates new form D_finanaaddout_closemoney
     */
    public D_finanaaddout_closemoney(D_finanaddout parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public D_finanaaddout_closemoney ()
    {
        super();
     initComponents();   
    }
...
new D_finanaaddout_closemony_addmangament(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_closemoney.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_closemoney dialog = new D_finanaaddout_closemoney(new D_finanaddout(), true);
