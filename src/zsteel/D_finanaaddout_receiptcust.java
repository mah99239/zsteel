 ...
 * @author mahmoud
 */
public class D_finanaaddout_receiptcust extends javax.swing.JDialog {

    DefaultTableModel m;
    public D_finanaaddout_receiptcust(D_finanaddout parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
     public D_finanaaddout_receiptcust(D_managaddbill parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
public D_finanaaddout_receiptcust()
{
  initComponents();
        dtable();   
}
    ...
    private void initComponents() {
        ...
        jLabel3.setText("فاتوره مرتجع جديده_عميل");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 0, 180, 30));
        ...
        jpdata2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 0, 50, 20));
        ...
        setSize(new java.awt.Dimension(853, 716));
...
//d.setVisible(true);
    ...
    private void jlgetsupplMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlgetsupplMouseClicked
            new D_finanaaddout_erceipt_getcustomer(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_receiptcust.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                D_finanaaddout_receiptcust dialog ;
                     dialog   = new D_finanaaddout_receiptcust(new D_finanaddout(), true);
                     dialog   = new D_finanaaddout_receiptcust(new D_managaddbill(), true);
