 ...
 * @author mahmoud
 */
public class D_finanaaddout_closemony_addmangament extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finanaaddout_closemony_addmangament(D_finanaaddout_closemoney parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
        
    }
    public D_finanaaddout_closemony_addmangament(D_finanaaddout_mangamentmony parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("اختر احد مسئولى الماليات");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 0, 160, 30));
        ...
        jpaddsupp.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 30, 40));
        ...
        jpaddsupp.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 190, 20));

        jPanel1.add(jpaddsupp, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 240, 40));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 480, 240, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_closemony_addmangament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_closemony_addmangament dialog = new D_finanaaddout_closemony_addmangament(new D_finanaaddout_closemoney(), true);
