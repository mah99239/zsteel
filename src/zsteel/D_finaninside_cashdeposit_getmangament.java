 ...
 * @author mahmoud
 */
public class D_finaninside_cashdeposit_getmangament extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finaninside_cashdeposit_getmangament(D_finaninside_cashdeposit parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_cashdeposit_getmangament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_cashdeposit_getmangament dialog = new D_finaninside_cashdeposit_getmangament(new D_finaninside_cashdeposit(), true);
