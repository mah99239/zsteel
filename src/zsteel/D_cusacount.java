 ...
 * @author mahmoud
 */
public class D_cusacount extends javax.swing.JDialog {

    DefaultTableModel m;
    public D_cusacount(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
    ...
    private void initComponents() {
        ...
        jrb_data1.setText("عرض كل معاملات العميل");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_cusacount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_cusacount dialog = new D_cusacount(new javax.swing.JFrame(), true);
