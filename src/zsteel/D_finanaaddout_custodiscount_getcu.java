 ...
 * @author mahmoud
 */
public class D_finanaaddout_custodiscount_getcu extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finanaaddout_custodiscount_getcu(D_finanaaddout_custodiscount  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_custodiscount_getcu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_custodiscount_getcu dialog = new D_finanaaddout_custodiscount_getcu(new D_finanaaddout_custodiscount(), true);
