 ...
 * @author mahmoud
 */
public class D_store1 extends javax.swing.JDialog {

    DefaultTableModel m;
    public D_store1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("تقرير النواقص");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 5, 180, 20));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 510, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_store1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_store1 dialog = new D_store1(new javax.swing.JFrame(), true);
