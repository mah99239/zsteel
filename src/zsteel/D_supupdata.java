 ...
 * @author mahmoud
 */
public class D_supupdata extends java.awt.Dialog {

    
    
    public D_supupdata(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("تعديل بينات المورد");
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 370, 30));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_supupdata dialog = new D_supupdata(new java.awt.Frame(), true);
