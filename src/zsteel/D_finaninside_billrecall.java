 ...
 * @author mahmoud
 */
public class D_finaninside_billrecall extends javax.swing.JDialog {
       public boolean a;
    DefaultTableModel m;
    public D_finaninside_billrecall(D_finaninside parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
    public D_finaninside_billrecall(D_managaddbill parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
public D_finaninside_billrecall()
{
  initComponents();
        dtable();   
}
    ...
    private void initComponents() {
        ...
        jLabel3.setText("فاتوره مرتجع جديده-مورد");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, 150, 30));
...
//d.setVisible(true);
 ...
 new D_finaninside_billrecall_getsupp(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_billrecall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_billrecall dialog ;
                     dialog   = new D_finaninside_billrecall(new D_finaninside(), true);
                      dialog   = new D_finaninside_billrecall(new D_managaddbill(), true);
