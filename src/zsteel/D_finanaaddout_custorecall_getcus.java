 ...
 * @author mahmoud
 */
public class D_finanaaddout_custorecall_getcus extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finanaaddout_custorecall_getcus(D_finanaaddout_custorecall  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_custorecall_getcus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_custorecall_getcus dialog = new D_finanaaddout_custorecall_getcus(new D_finanaaddout_custorecall(), true);
