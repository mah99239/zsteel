 ...
 * @author mahmoud
 */
public class D_finaninside_cashdepositcustmor extends javax.swing.JDialog {

    /**
     * Creates new form D_finanaaddout_closemoney
     */
    public D_finaninside_cashdepositcustmor(D_finaninside parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public D_finaninside_cashdepositcustmor ()
    {
        super();
     initComponents();   
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ايداع نقدى لحساب عميل");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 150, 30));
...
new D_finanaddout_data(this, true).setVisible(true);
    ...
    private void jlgetsupplMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jlgetsupplMouseClicked
        new D_finaninside_cashdepositcustmor_getcus(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_cashdepositcustmor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_cashdepositcustmor dialog = new D_finaninside_cashdepositcustmor(new D_finaninside(), true);
