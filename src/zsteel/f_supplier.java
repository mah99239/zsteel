...
public class f_supplier extends javax.swing.JFrame {
 ...
 table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("بيانات الموردين");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "الموردين الخالصين","الموردين المدينين  ", "الموردين الدائنين", "عرض كل الموردين" }));
        ...
        jLabel2.setText("عرض باالماليات");
        ...
        table.setModel(new DefaultTableModel(new Object[0][], new String []{"مسلسل","اسم المورد","كود المورد","اخر دفعه","دائن","مدين","تاريخ اخر تحديث"}));
        ...
        jBedit.setText("تعديل بيانات المورد");
        ...
        jBdelete.setText("مسح بيانات المورد");
...
jBarchife.setBackground(Color.white);
 ...
 table.setRowHeight(table.getRowHeight()+1);
    ...
    public  void dtable ()
    {
        String [] columnx = {"مسلسل","اسم المورد","كود المورد","اخر دفعه","دائن","مدين","تاريخ اخر تحديث"};
