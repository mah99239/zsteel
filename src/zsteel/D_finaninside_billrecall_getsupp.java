 ...
 * @author mahmoud
 */
public class D_finaninside_billrecall_getsupp extends javax.swing.JDialog {

    DefaultTableModel m;
    
    public D_finaninside_billrecall_getsupp(D_finaninside_billrecall  parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finaninside_billrecall_getsupp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finaninside_billrecall_getsupp dialog = new D_finaninside_billrecall_getsupp(new D_finaninside_billrecall(), true);
