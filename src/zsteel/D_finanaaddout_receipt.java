 ...
 * @author mahmoud
 */
public class D_finanaaddout_receipt extends javax.swing.JDialog {

    DefaultTableModel m;
    public D_finanaaddout_receipt(D_finanaddout parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
     public D_finanaaddout_receipt(D_managaddbill parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dtable();
    }
public D_finanaaddout_receipt()
{
  initComponents();
        dtable();   
}
    ...
    private void initComponents() {
        ...
        jLabel3.setText("فاتوره شراء جديده");
        ...
        setSize(new java.awt.Dimension(853, 700));
...
//d.setVisible(true);
 ...
 new D_finanaaddout_erceipt_getsupplier(this, true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_finanaaddout_receipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_finanaaddout_receipt dialog ;
                       dialog = new D_finanaaddout_receipt(new D_finanaddout(), true);
                       dialog = new D_finanaaddout_receipt(new D_managaddbill(), true);
